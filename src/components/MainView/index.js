...
import { Nav, Navbar, Form, Button, FormControl, Badge, Tab, Tabs } from "react-bootstrap";
			...
			<React.Fragment>
							...
							<div className="row">
								<div className="col-6 text-center pb-0">
									<Nav.Link eventKey="delivered">
										<div className="m-2">
											Utlevert <Badge variant="success">{statusCountDelivered.length}</Badge>
										</div>
									</Nav.Link>
								</div>
								<div className="col-6 text-center pb-0">
				...
				>
					...
					<Nav.Link eventKey="in-process">
						Under behandling <Badge variant="success">{statusCountInProcess.length}</Badge>
						{/* Under behandling ({statusCountInProcess.length}){" "} */}
					</Nav.Link>
					<Nav.Link eventKey="packed">
						Til henting <Badge variant="success">{statusCountPacked.length}</Badge>
